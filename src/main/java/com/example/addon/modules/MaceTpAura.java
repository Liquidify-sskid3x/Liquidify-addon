...
public class MaceTpAura extends Module {
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        // Check for mace first — disable module if missing
        ...
        if (target != null) {
            ...
            // No target found — if we just killed one, return to ground
            if (wasTargetFound) {
                sendToGround();
                wasTargetFound = false;
            }
    ...
    private void sendToGround() {
        ...
        // Find the surface Y by stepping downward from the player's current position
