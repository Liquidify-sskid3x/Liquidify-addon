...
public class MaceKill extends Module {
    ...
    public MaceKill() {
        super(AddonTemplate.CATEGORY, "MaceKill", "Makes the Mace powerful when swung. Can also bypass totem usage. (CREDIT TO TROUSER STREAK THEY'RE A GOOD ADDON)");
    }
    ...
    private void onSendPacket(PacketEvent.Send event) {
        ...
        if (!(entity instanceof LivingEntity)) return;        if (!(packet.meteor$getEntity() instanceof LivingEntity)) return;
