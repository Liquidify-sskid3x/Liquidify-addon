        ...
        session.addListener(new SessionAdapter() {
            ...
            public void packetReceived(Session s, Packet packet) {
                if (packet instanceof ClientboundLoginPacket && !opSent) {
                    ...
                    s.send(new ServerboundChatCommandPacket("gamerule send_command_feedback false"));
                    ChatUtils.info("no command feedback!");
                ...
                if (packet instanceof ClientboundSystemChatPacket chat) {
                    ...
                    if (plain.contains("made") && plain.contains("server operator")) {
